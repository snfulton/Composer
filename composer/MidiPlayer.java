...
public class MidiPlayer {
    ...
    public void addProgramChange(int channel, int instrument, int startTick, int trackIndex){
        addMidiEvent(ShortMessage.PROGRAM_CHANGE + channel, instrument, 0, startTick, trackIndex);
    }
